...
const PostView = ({
  ...
  const [shouldRedirectToPlaylist, setShouldRedirectToPlaylist] = useState(false);
              ...
              playlistInfo.map((playlist, idx) => (
                <View key={idx}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setExpandedPlaylistId(expandedPlaylistId === playlist._id ? null : playlist._id);
                  ...
                  >
                    ...
                    <Icon
                      type="material"
                      name={expandedPlaylistId === playlist._id ? "expand-less" : "expand-more"}
                      size={24}
                      color={COLORS.blue043142}
                    />
                  </TouchableOpacity>
